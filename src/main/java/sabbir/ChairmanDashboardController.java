...
{
    @FXML
    private Label openDisputeLabel;
    @FXML
    private Label pendingPolicyLabel;
    @FXML
    private Label pendingResultLabel;
    ...
    public void handleFinalApproval(ActionEvent actionEvent) {
        openNewStage("finalmarksapproval.fxml", "Final Marks Approval (Goal 1)");
    }
    ...
    public void handleAuditReports(ActionEvent actionEvent) {
        openNewStage("auditreportviewer.fxml", "Audit Report Viewer (Goal 3)");
    }
    ...
    public void handleScheduleChange(ActionEvent actionEvent) {
        openNewStage("schedulechangeapproval.fxml", "Schedule Change Approval (Goal 6)");
    }

    @FXML
    public void handleDisputeResolution(ActionEvent actionEvent) {
        openNewStage("disputeresolutionmodule.fxml", "Dispute Resolution (Goal 5)");
    }
